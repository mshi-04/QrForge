...
| Skill | 用途 | 定義 |
|------|------|------|
| `coding` | 実装・修正作業 | [.claude/skills/coding/SKILL.md](.claude/skills/coding/SKILL.md) |
| `unit-test` | UnitTest 作成・修正 | [.claude/skills/unit-test/SKILL.md](.claude/skills/unit-test/SKILL.md) |
| `layer-review` | コードレビュー | [.claude/skills/layer-review/SKILL.md](.claude/skills/layer-review/SKILL.md) |
